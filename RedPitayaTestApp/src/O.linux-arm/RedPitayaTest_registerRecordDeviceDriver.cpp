...
/* Generated from ../O.Common/RedPitayaTest.dbd */
...
epicsShareExtern reg_func pvar_func_RedPitaya_Startup,
...
int RedPitayaTest_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/root/redpitaya-epics";
    ...
    runRegistrarOnce(pvar_func_RedPitaya_Startup);
...
/* RedPitayaTest_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"RedPitayaTest_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    iocshSetError(RedPitayaTest_registerRecordDeviceDriver(*iocshPpdbbase));
}
